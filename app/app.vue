  ...
  <div class="min-h-screen flex flex-col relative bg-bg text-text">
    <header class="fixed top-0 left-0 right-0 z-50 px-4 md:px-8 py-4 backdrop-blur-xl bg-bg/80 border-b border-border">
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav class="hidden lg:flex items-center gap-6 absolute left-1/2 -translate-x-1/2">
          ...
          <a href="https://github.com/Kamsou/ousontlesdevs" target="_blank" rel="noopener noreferrer" class="text-text-muted/60 no-underline text-sm font-medium transition-colors hover:text-text whitespace-nowrap flex items-center gap-1.5">
    ...
    <div v-if="menuOpen" class="fixed inset-0 z-40 bg-bg pt-20 px-6 lg:hidden">
      <nav class="flex flex-col gap-6 py-8">
        ...
        <a href="https://github.com/Kamsou/ousontlesdevs" target="_blank" rel="noopener noreferrer" class="text-text-muted/60 no-underline text-2xl font-medium inline-flex items-center gap-3">
